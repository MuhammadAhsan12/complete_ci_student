...
class Welcome extends CI_Controller {
    ...
    public function pdf($id)
	{
        ...
        $html = $this->load->view('pdfteacher',$data,true);
        $mpdf = new \Mpdf\Mpdf();
        $mpdf->WriteHTML($html);
        $url = 'teacher.pdf';
    ...
    public function ajax_list()
    {
        ...
        $row[] = '<a class="btn btn-sm btn-primary" href="javascript:void(0)" title="Edit" onclick="edit_person('."'".$person->id."'".')"><i class="glyphicon glyphicon-pencil"></i></a>
            ...
            <a class="btn btn-sm btn-default" href="javascript:void(0)" title="View" onclick="view_person('."'".$person->id."'".')"><i class="glyphicon glyphicon-circle-arrow-right"></i></a>
            <a class="btn btn-sm btn-default" href="javascript:void(0)" title="pdf" onclick="view_pdf('."'".$person->id."'".')"><i class="glyphicon glyphicon-file"></i></a>';
